...
const styles = StyleSheet.create({
  ...
  fieldBox: { borderWidth: 2, borderColor: '#333', paddingVertical: 14, paddingHorizontal: 12 },
  fieldValue: { color: 'white', fontSize: 20 },

  nameInput: { backgroundColor: '#1f1f1f', color: 'white', fontSize: 20, paddingVertical: 12, paddingHorizontal: 12 },
